...
function inferType(urlString) {
  console.log('inferType called with arg ' + urlString);
  ...
  console.log('url is ' + urlString + ' and urlObject is ' + JSON.stringify(urlObject))
...
function renderLink(input, options) {
  console.log('renderLink called with input ' + input);
